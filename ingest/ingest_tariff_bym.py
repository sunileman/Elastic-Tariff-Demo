...
from utils.es_config import index_name, settings, byom_mapping, deleteExistingIndex
...
file_paths = ["../output/workplace-app-tariffs-bym.json"]

##create index
manage_index(es, index_name, settings, byom_mapping, deleteExistingIndex)
